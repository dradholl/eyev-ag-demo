...
class OKGEngine:
    ...
    def draft_response(self, result):
        ...
        if top_presentation_id == "PR051":
            return {
                "Summary": "This appears to be stable known pseudopapilloedema / optic disc drusen without new symptoms.",
                "Suggested response": (
                ...
                "Safety net": "If there are new headaches, transient visual obscurations, diplopia, vomiting, reduced vision, field loss, or concern for true disc swelling, please refer urgently using the local ophthalmology pathway.",
            }
